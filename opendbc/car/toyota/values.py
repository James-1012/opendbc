...
class CAR(Platforms):
  ...
  TOYOTA_PRIUS_5TH_GEN = ToyotaTSS2PlatformConfig(
    ...
    dbc_dict('toyota_prius_2025_pt', None),
...
EPS_SCALE = defaultdict(lambda: 73,
                        {CAR.TOYOTA_PRIUS_5TH_GEN: 66, CAR.TOYOTA_PRIUS: 66, CAR.TOYOTA_COROLLA: 88, CAR.LEXUS_IS: 77, CAR.LEXUS_RC: 77, CAR.LEXUS_CTH: 100, CAR.TOYOTA_PRIUS_V: 100})
